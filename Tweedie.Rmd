...
```{r}
# Read the CSV file into a data.table (assuming 'selected_features.csv' is in the working directory)
...
# Print the first few rows of df_encoded to check the encoding
head(df_encoded)
